...
![alt text](https://img.shields.io/badge/Compute-PyTorch-EE4C2C?style=for-the-badge&logo=pytorch&logoColor=white)


![alt text](https://img.shields.io/badge/Models-Hugging%20Face-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black)


![alt text](https://img.shields.io/badge/Intelligence-Google%20Gemini%201.5-4285F4?style=for-the-badge&logo=google&logoColor=white)


![alt text](https://img.shields.io/badge/ASR-Whisper-000000?style=for-the-badge&logo=openai&logoColor=white)


![alt text](https://img.shields.io/badge/Frontend-ES6%2B-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black)
...
Pipeline: User Keyword 
→
→
 LLM Prompt Expansion 
→
→
 Transformer Audio Generation 
→
→
 FFMPEG Processing 
→
